...
public class ListaConsejo {
	...
	public ListaConsejo() {
		...
		consejos.add(new Consejo((long) 4,"Mudanzas. Consejos para que sea un éxito","Los cambios de hogar son siempre un estres, para nosotros y para ellos. En esta nota te damos tips para que prepares a tus mascotas para el cambio, y que sea todo un éxito. Para facilitar la transición debemos: /n"+" "+
			...
			"No cambiar ni renovar su cama, cobija y/o casa.", true));
		consejos.add(new Consejo((long) 5,"Consejos útiles para viajar con tu mascota","Viajar con tu mascota, puede ser una aventura increíble, o una mala experiencia para ambos. /n"+ " "+
			...
			"Si viajas en transporte terrestre público, es fundamental que hables con el conductor y establezcas las condiciones para transportar a tu mascota. En ocasiones te obligarán a proteger el asiento, ubicarlo en el piso, usar una jaula o alejarlo de los demás pasajeros.", true));
