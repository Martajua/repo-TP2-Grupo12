...
public class ListaSucursal {
	...
	public ListaSucursal() {
		...
		sucursales.add(new Sucursal("Jujuy", "CASA CENTRAL", "Av. Fuerza Aérea N°200 - B° Alto Comedero", "3885 840391", "Lunes a Sábados de 9 a 21 hs","ID 01-01"));
		sucursales.add(new Sucursal("Jujuy", "SUCURSAL LAVALLE", "Lavalle N°222- Local A", "3885 840394", "Lunes a Sábados de 9 a 22 hs"," ID 01-02"));
